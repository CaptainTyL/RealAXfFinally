...
public class ClassifyFragment extends BaseFragment {
    ...
    private void getHttpShopTypeListData(final String sortingType, final String listType) {
        ...
        String userName=SharePrefUtil.getString(getActivity(),"UserName","1");
                ...
                if (tejiaShopListBean.getData() != null) {
                    ...
                    classShopListAdpater.setOnRecyclerItemClickListener(new OnRecyclerItemClickListener() {
                        ...
                        public void onItemClick(View view, int position) {
                            ...
                            intent.putExtra("shopImage",classShopList.get(position).getGoodsbigurl());
                            intent.putExtra("shopName",classShopList.get(position).getGoodsname());
                            intent.putExtra("vipPrice",classShopList.get(position).getGoodsvipprice());
                            intent.putExtra("nomalPrice",classShopList.get(position).getGoodsprice());
                            intent.putExtra("goodsId",classShopList.get(position).getGoodsid());
